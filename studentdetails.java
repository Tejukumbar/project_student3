public class studentdetails {
    ...
    public studentdetails(String name, String department, int semester, int subject1, int subject2, int subject3) {
        this.name = name;
    ...
    public static void main(String[] args) {
        ...
        studentdetails student = new studentdetails("John Doe", "CS", 5, 85, 92, 78);
